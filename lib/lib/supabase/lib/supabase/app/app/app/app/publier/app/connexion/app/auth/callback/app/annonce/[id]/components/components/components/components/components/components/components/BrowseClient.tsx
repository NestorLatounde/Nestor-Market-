...
export default function BrowseClient({
  ...
  // Quand aucune annonce ne correspond exactement à la commune recherchée,
  // on interroge Supabase pour trouver les annonces les plus proches par
  // vraie distance GPS (si la position du visiteur est connue).
  useEffect(() => {
    let cancelled = false;
    if (!needsFallback) {
